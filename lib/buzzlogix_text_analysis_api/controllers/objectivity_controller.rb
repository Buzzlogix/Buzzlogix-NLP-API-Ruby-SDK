...
module BuzzlogixTextAnalysisApi
  class ObjectivityController
    ...
    def create_return_english_objectivity_plaintext body
    ...
    # @return mixed response from the API call
    def create_return_english_objectivity_multipart_form text
      # the base uri for api requests
      query_builder = Configuration.BASE_URI.dup
    ...
    # @return mixed response from the API call
    def create_return_english_objectivity_encoded_form text
      # the base uri for api requests
      query_builder = Configuration.BASE_URI.dup
