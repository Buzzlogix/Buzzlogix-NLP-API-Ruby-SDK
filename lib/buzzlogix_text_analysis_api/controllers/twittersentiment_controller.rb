...
module BuzzlogixTextAnalysisApi
  class TwittersentimentController
    ...
    def create_return_english_twitter_sentiment_plaintext body
    ...
    # @return mixed response from the API call
    def create_return_english_twitter_sentiment_multipart_form text
      # the base uri for api requests
      query_builder = Configuration.BASE_URI.dup
    ...
    # @return mixed response from the API call
    def create_return_english_twitter_sentiment_encoded_form text
      # the base uri for api requests
      query_builder = Configuration.BASE_URI.dup
